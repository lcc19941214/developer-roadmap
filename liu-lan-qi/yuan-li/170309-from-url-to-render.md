...
这里需要补充一点的是，光靠 IP 地址是无法进行通信的，因为 IP 地址并不和某台设备绑定（比如使用了[DHCP](https://zh.wikipedia.org/zh-cn/动态主机设置协议)）。所以在底层通信时需要使用一个固定的地址，即结合MAC协议来建立连接。

#### 建立TCP连接

![TCP&#x4E09;&#x6B21;&#x63E1;&#x624B;](../../.gitbook/assets/2018-07-20-17-38-49.png)
...
![HTTP&#x8BF7;&#x6C42;&#x548C;&#x54CD;&#x5E94;&#x7684;&#x6D88;&#x606F;&#x62A5;&#x5934;&#x4E2D;&#xFF0C;&#x5E38;&#x89C1;&#x7684;&#x4E0E;&#x7F13;&#x5B58;&#x6709;&#x5173;&#x7684;&#x6D88;&#x606F;&#x62A5;&#x5934;](../../.gitbook/assets/2018-07-20-17-39-49.png)

**用户操作行为与缓存**

用户在使用浏览器的时候，会有各种操作，这些行为会对缓存如下：

![&#x7528;&#x6237;&#x64CD;&#x4F5C;&#x4E0E;&#x7F13;&#x5B58;](../../.gitbook/assets/2018-07-20-17-40-07.png)
...
> 参考
>
> * [hosts文件](https://zh.wikipedia.org/wiki/Hosts文件)
...
![performance api&#x5BF9;&#x5E94;&#x7684;&#x8D44;&#x6E90;&#x8BF7;&#x6C42;&#x5E76;&#x52A0;&#x8F7D;&#x7684;&#x8FC7;&#x7A0B;](../../.gitbook/assets/2018-07-20-17-41-14.png)
...
* **浏览器引擎**  在用户界面和呈现引擎之间传送指令
  * [**呈现引擎**](https://zh.wikipedia.org/wiki/排版引擎)  也称为浏览器内核、排版引擎。负责渲染请求的内容，以HTML为例，呈现引擎会解析HTML和CSS并显示到屏幕上。
  * [**JS引擎**](https://zh.wikipedia.org/wiki/JavaScript引擎)  用于解析和执行 JavaScript 代码
...
![](../../.gitbook/assets/2018-07-26-12-18-18.png)
